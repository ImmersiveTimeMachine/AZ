...
/**
 * Holds attributes related to weapons, primarily ammunition counts.
 * This AttributeSet is intended to live on a Weapon Actor itself.
 */
UCLASS()
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Pistol", ReplicatedUsing = OnRep_PistolClipAmmo)
	FGameplayAttributeData PistolClipAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, PistolClipAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Rifle", ReplicatedUsing = OnRep_RifleClipAmmo)
	FGameplayAttributeData RifleClipAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, RifleClipAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Shotgun", ReplicatedUsing = OnRep_ShotgunClipAmmo)
	FGameplayAttributeData ShotgunClipAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, ShotgunClipAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|SMG", ReplicatedUsing = OnRep_SMGClipAmmo)
	...
	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Pistol", ReplicatedUsing = OnRep_PistolReserveAmmo)
	FGameplayAttributeData PistolReserveAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, PistolReserveAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Rifle", ReplicatedUsing = OnRep_RifleReserveAmmo)
	FGameplayAttributeData RifleReserveAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, RifleReserveAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Shotgun", ReplicatedUsing = OnRep_ShotgunReserveAmmo)
	FGameplayAttributeData ShotgunReserveAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, ShotgunReserveAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|SMG", ReplicatedUsing = OnRep_SMGReserveAmmo)
	FGameplayAttributeData SMGReserveAmmo;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, SMGReserveAmmo);

	UPROPERTY(BlueprintReadOnly, Category = "Ammo|Rocket", ReplicatedUsing = OnRep_RocketReserveAmmo)
	...
	UPROPERTY(BlueprintReadOnly, Category = "Weapon Stats", ReplicatedUsing = OnRep_BaseDamage)
	FGameplayAttributeData BaseDamage;
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, BaseDamage);

	UPROPERTY(BlueprintReadOnly, Category = "Weapon Stats", ReplicatedUsing = OnRep_FireRate)
	FGameplayAttributeData FireRate; // e.g., Shots per second
	ATTRIBUTE_ACCESSORS(UAZ_WeaponAttributeSet, FireRate);

	UPROPERTY(BlueprintReadOnly, Category = "Weapon Stats", ReplicatedUsing = OnRep_ReloadTime)
