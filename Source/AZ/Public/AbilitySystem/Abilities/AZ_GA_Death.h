 ...
 * animated corpse state (nonblocking collapse, then a settled body with query collision).
 *
...
protected:
	...
	/** Legacy ragdoll tuning, retained for existing assets. Animated corpses settle when the clip finishes. */
