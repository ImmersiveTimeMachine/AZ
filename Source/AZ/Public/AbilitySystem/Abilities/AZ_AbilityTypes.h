...
#include "AZ_AbilityTypes.generated.h"
...
struct AZ_API FAZ_GameplayEffectContainer
{
	GENERATED_BODY()

	FAZ_GameplayEffectContainer() {}

	/** Sets the way that targeting happens */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = GameplayEffectContainer)
	TSubclassOf<UAZ_TargetType> TargetType;
...
USTRUCT(BlueprintType)
struct AZ_API FAZ_GameplayEffectContainerSpec
{
	GENERATED_BODY()

	FAZ_GameplayEffectContainerSpec() {}
