...
#include "AZ_AT_PlayMontageForMeshAndWaitForEvent.generated.h"

class UAZ_AbilitySystemComponent;
/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FAZPlayMontageForMeshAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
...
UCLASS()
class AZ_API UAZ_AT_PlayMontageForMeshAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
	public:
	// Constructor and overrides
	UAZ_AT_PlayMontageForMeshAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FAZPlayMontageForMeshAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageForMeshAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageForMeshAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageForMeshAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageForMeshAndWaitForEventDelegate EventReceived;
	...
	static UAZ_AT_PlayMontageForMeshAndWaitForEvent* PlayMontageForMeshAndWaitForEvent(
