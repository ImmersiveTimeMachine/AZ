...
#include "AZ_AT_PlayMontageAndWaitForEvent.generated.h"

class UAZ_AbilitySystemComponent;
/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FAZPlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
...
UCLASS()
class AZ_API UAZ_AT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
	public:
	// Constructor and overrides
	UAZ_AT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FAZPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FAZPlayMontageAndWaitForEventDelegate EventReceived;
	...
	static UAZ_AT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UAZ_AbilitySystemComponent* GetTargetASC() const;
	...
	void OnGameplayEvent(FGameplayTag InEventTag, const FGameplayEventData* InPayload);
