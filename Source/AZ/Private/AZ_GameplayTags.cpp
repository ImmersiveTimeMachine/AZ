...
void FAZ_GameplayTags::InitializeNativeGameplayTags()
{
    ...
    AddTag(GameplayTags.State_Throwable_Stowing,      FName("State.Throwable.Stowing"),      TEXT("The throwable's put-away clip is still playing; a weapon draw started under it would be invisible"));
    ...
    AddTag(GameplayTags.Combat_Ready,           FName("Combat.Ready"),           TEXT("Upper-body fists-up combat stance — timed, auto-clears after CombatReadyDuration; refreshed on equip/attack"));
    ...
    AddTag(GameplayTags.Event_Traversal_Handoff, FName("Event.Traversal.Handoff"), TEXT("Anim-led: the traversal clip has reached supported ground — locomotion may take the body back (moving mantles only)"));
