...
#include "InventoryOld/Widgets/Composite/AZ_Inv_Leaf_LabeledValue.h"

#include "Components/TextBlock.h"

void UAZ_Inv_Leaf_LabeledValue::SetText_Label(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UAZ_Inv_Leaf_LabeledValue::SetText_Value(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UAZ_Inv_Leaf_LabeledValue::NativePreConstruct()
{
