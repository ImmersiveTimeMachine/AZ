...
1. Scan `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\MEMORY.md` for matching topic.
...
See `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_check_memory_first.md` for the full rule and incident.
...
See `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_use_agent_teams.md`.
...
See `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_validate_agent_findings.md`.
...
See `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_no_read_approval.md`.
...
See `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_file_paths.md`.

## When to save NEW memory

Save when you have: a workflow rule we wish past Codex had known; a non-obvious fix (root cause + symptom + resolution); an architectural decision with rationale.
