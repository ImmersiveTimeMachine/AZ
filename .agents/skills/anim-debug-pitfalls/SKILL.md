...
**Full context:** `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_animbp_post_event_vs_thread_safe.md`
...
**Full context:** `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\feedback_animgraph_node_reference_wiring.md`
...
**Full context:** `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\project_idle_tip_implementation.md` (§ "OffsetRootBone enum mapping").
...
**Full context:**
- `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\gasp_orientation_intent_tip.md` (per-mode rules verbatim, 4-pitfall list)
- `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\project_idle_tip_implementation.md` (AZ working baseline + tuning knobs)
- `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\gasp_sm_tip_flow.md` (Conduit→TransIdle entry, Re-Enter rule = bare `Enable_TurnInPlaceSteering < 0.1`).
...
**Full context:** `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\gasp_update_logic_flow.md` (full idle-walk-idle cycle, exact `IsMoving` body, missing-fields list, mesh-space facing offset trap).
...
**Full context:** `C:\Users\Artur\.Codex\projects\C--UnrealEngine-Games-AZ\memory\feedback_blendstack_input_node_ref.md` (§ Second incident) + `project_jump_system_status.md` (§ TRUE ROOT CAUSE 2026-06-06).
...
For binding readouts to work end-to-end, the local UnrealClaude plugin patch in `C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\project_local_plugin_patches.md` § 1 must be applied to the editor's plugin source.
