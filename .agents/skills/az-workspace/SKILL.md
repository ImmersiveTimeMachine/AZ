...
| `.Codex\settings.local.json` | Codex permissions allowlist (per-project) |
| `.Codex\skills\` | Project-scoped skills (this file lives here) |
| `.mcp.json` | Project-scope MCP server registrations |

## Memory (persistent across sessions)

`C:\Users\Artur\.Codex\projects\C--UE57-Games-AZ\memory\`
