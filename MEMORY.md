...
- [project_cmc_rm_locomotion.md](project_cmc_rm_locomotion.md) — ★★★ START HERE for locomotion (commit 343d553): RM starts/stops via dynamic montages, 60% hand-back contract, stop entry-speed bands, the two foot bugs (FootSpeed_* curves don't exist; _LU means right-foot-planted), MM gating on a game-thread snapshot, CHT hooks additive.
