...
- [project_cmc_movement_feel_tuning.md](project_cmc_movement_feel_tuning.md) — ★ CMC feel: measured stop-clip decel profiles (foot slide = clipStopTime − speed/braking), live values + why, [CmcFeel] instrumentation, QUEUED gait-scaled braking. Read before touching BP_CMC_Hero movement values.
