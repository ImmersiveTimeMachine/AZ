...
- [project_cmc_velocity_master_verdict.md](project_cmc_velocity_master_verdict.md) — ★★★ START HERE for locomotion (commit fde7c55, 2026-08-26): THE VERDICT + Phase 1+2a LANDED — SM-owned selection in-place on UAZ_CmcAnimInstance (CMC FOR CMC, no new class/asset), measured ~1.00 capsule/clip fidelity on loops+starts+stops+pivots; residual RED = fixed-rate playback, Phase 2b (CHT+BlendStack dynamic play rate) is next. Supersedes the RM-locomotion direction below.
